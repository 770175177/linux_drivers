...
作者 : 左忠凯
版本 : V1.0
描述 : 设备树下的 platform 驱动
其他 : 无
论坛 : www.openedv.com
日志 : 初版 V1.0 2019/8/13 左忠凯创建
***************************************************************/
...
*/
static ssize_t
led_write (struct file *filp, const char __user * buf,
...
*/
static int
led_probe (struct platform_device *dev)
{
...
*/
static int
led_remove (struct platform_device *dev)
{
