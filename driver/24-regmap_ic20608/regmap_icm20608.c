...
static int icm20608_probe(struct spi_device *spi)
{
	...
	/* alloc icm20608dev object memory */
	icm20608dev = devm_kzalloc(&spi->dev, sizeof(*icm20608dev), GFP_KERNEL);
	if (!icm20608dev)
		return -ENOMEM;
#endif
	/* init regmap_config settings */
	icm20608dev.regmap_config.reg_bits = 8;   /* register length 8bit */
	icm20608dev.regmap_config.val_bits = 8;   /* value length 8bit */
	icm20608dev.regmap_config.read_flag_mask = 0x80;   /* read mask */
