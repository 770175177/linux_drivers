...
sdsada
	...
	*pGPL2DAT = 0x0;
	...
	if(!request_mem_region(GPL2_REGBASE, sizeof(gpl2_reg_t), "GPL2REG"))
		goto flag3;
	//baseaddr = ioremap(GPL2_REGBASE, sizeof(gpl2_reg_t));
	pGPL2REG = ioremap(GPL2_REGBASE, sizeof(gpl2_reg_t));
//	pGPL2REG->gpl2con = 0x11111111;
//	pGPL2REG->gpl2dat = 0x0;		
	//writel(0x11111111, *baseaddr);
	//writel(0x0, baseaddr+4);
	writel(0x11111111, &(pGPL2REG->gpl2con));
	writel(0x0, &(pGPL2REG->gpl2dat));
...
//	pGPL2REG->gpl2dat = 0x1;
	//writel(0x1, baseaddr+4);
	writel(0x1, &(pGPL2REG->gpl2dat));
#if 0
