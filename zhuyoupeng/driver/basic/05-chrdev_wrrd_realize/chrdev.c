...
static ssize_t test_chrdev_read (struct file *, const char __user *, size_t, loff_t *);
...
static ssize_t test_chrdev_read (struct file *file, const char __user *ubuf, size_t count, loff_t *ppos)
{
	int ret = -1;
